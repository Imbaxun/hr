...
class JBProcess extends Component {
  ...
  render(){
    ...
    return(
      <div>
        ...
        <div>
        <h1 style={{textAlign:"center"}}>加班申请单</h1>
        ...
        <Col span = '8'>
          ...
          <Col span = '8'>
            <div style={{display:'flex'}}>
              ...
              <Input value={flowData.type || '未填写'} readOnly style={{ width:200}}  />
            </div>
          </Col>
          <Col span='8'></Col>
        </Row>
        ...
        <div  style={{display:'none'}}>
          <div id='mainConent' style={{fontSize:16}}>
            <h1 style={{textAlign:'center', marginBottom:20}}>加班申请单</h1>
